...
cron：5 0 * * *
ref：https://raw.githubusercontent.com/evilbutcher/Quantumult_X/master/check_in/glados/checkincookie_env.js
*/
...
// custom variable
const jcqdCookie = ($.isNode() ? process.env.jcqdCookie : $.getdata('jcqdCookie')) || '';
const jcqdSignUrl = ($.isNode() ? process.env.jcqdSignUrl : $.getdata('jcqdSignUrl')) || '';
...
!(async () => {
  ...
  // use custom variable
  checkin(jcqdSignUrl, jcqdCookie, name);
})()
  .catch((e) => {
    $.log("", `❌失败! 原因: ${e}!`, "");
  })
